...
export function InstallBanner() {
  ...
  return (
    <div className="flex items-center gap-2 border-b border-blue-200/60 bg-blue-50/80 px-3 py-1.5 text-xs text-blue-800 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-300">
